...
exports.GetActions = exports.ActionId = void 0;
let CHANNEL_CHOICES = [];
let MIX_CHOICES = [];
const FADER_CHOICES = [
    { label: '0 db', id: 0 },
...
var ActionId;
(function (ActionId) {
    ActionId["Action_SetChannelVolume"] = "Action_SetChannelVolume";
    ActionId["Action_SetMixVolume"] = "Action_SetMixVolume";
    ActionId["Action_SoloChannel"] = "Action_SoloChannel";
    ActionId["Action_MuteChannel"] = "Action_MuteChannel";
    ActionId["Action_SnapshotIdUpdate"] = "Action_SnapshotIdUpdate";
    ActionId["Action_SnapshotCurrentUpdate"] = "Action_SnapshotCurrentUpdate";
    ActionId["Action_SnapshotIdGo"] = "Action_SnapshotIdGo";
    ActionId["Action_SnapshotIndexGo"] = "Action_SnapshotIndexGo";
    ActionId["Action_SnapshotNext"] = "Action_SnapshotNext";
    ActionId["Action_SnapshotPrev"] = "Action_SnapshotPrev";
    ActionId["Action_SnapshotFirst"] = "Action_SnapshotFirst";
    ActionId["Action_MixMode"] = "Action_MixMode";
...
function GetActions(instance) {
    ...
    const actions = {
        ...
        [ActionId.Action_SnapshotCurrentUpdate]: {
            ...
            callback: () => {
                if (instance.OSC)
                    instance.OSC.sendCommand('/Kf/co/updateSnaphot');
            },
        },
        [ActionId.Action_SnapshotIdGo]: {
            ...
            callback: (action) => {
                if (instance.OSC)
                    instance.OSC.sendCommand('/Kf/co/recall', [{ type: 'i', value: action.options.snapshot }]);
            },
        },
        [ActionId.Action_SnapshotIndexGo]: {
            ...
            callback: (action) => {
                if (instance.OSC)
                    instance.OSC.sendCommand('/Kf/co/recallInd', [{ type: 'i', value: action.options.snapshot }]);
            },
        },
        [ActionId.Action_SnapshotNext]: {
            ...
            callback: () => {
                if (instance.OSC)
                    instance.OSC.sendCommand('/Kf/co/recallNext');
            },
        },
        [ActionId.Action_SnapshotPrev]: {
            ...
            callback: () => {
                if (instance.OSC)
                    instance.OSC.sendCommand('/Kf/co/recallPrev');
            },
        },
        [ActionId.Action_SnapshotFirst]: {
            ...
            callback: () => {
                if (instance.OSC)
                    instance.OSC.sendCommand('/Kf/co/recallFirst');
            },
        },
    };
    return actions;
